          ...
          children: [
            ...
            Column(
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [HomeText(nText: 'ORDERS',), HomeText(nText: 'PROFILE')],
                )
              ],
            ),
            SizedBox(
            ...
            Column(
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [HomeText(nText: 'LOCATION'), HomeText(nText: 'LISTING')],
                )
              ],
            ),
          ],
